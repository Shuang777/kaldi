...
int main(int argc, char *argv[]) {
  ...
  try {
    const char *usage =
        ...
        "\n"
        "Usage:  multi-nnet-forwardback [options] <model-in> <feature-rspecifier> <feature-wspecifier>\n"
        "e.g.: \n"
        " multi-nnet-forwardback nnet ark:features.ark ark:mlpoutput.ark\n";
    ...
    CuMatrix<BaseFloat> nnet_backout;
