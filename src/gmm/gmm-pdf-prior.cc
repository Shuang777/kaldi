...
void PdfPrior::GetLogPriors(Vector<BaseFloat> *log_priors_vec) {
  log_priors_vec->Resize(log_priors_.Dim());
  log_priors_vec->CopyFromVec(log_priors_);
}
