...
inline void cuda_avg_mat(dim3 Gr, dim3 Bl, const float *src, float *dst, MatrixDim d) { cudaF_avg_mat(Gr,Bl,src,dst,d); }
...
inline void cuda_compute_entropy(size_t Gr, size_t Bl, const float *y, float *x, MatrixDim d) { cudaF_compute_entropy(Gr,Bl,y,x,d); }
...
inline void cuda_avg_mat(dim3 Gr, dim3 Bl, const double *src, double *dst, MatrixDim d) { cudaD_avg_mat(Gr,Bl,src,dst,d); }
...
inline void cuda_compute_entropy(size_t Gr, size_t Bl, const double *y, double *x, MatrixDim d) { cudaD_compute_entropy(Gr,Bl,y,x,d); }
